...
const en = {
  meta: {
    // Title carries the service and the city because the H1 deliberately does
    // not — the hero line is the brand, the title tag is the search surface.
    title: 'Web Design & Development in Ottawa | Zyvanta',
    description:
      'Bilingual web design and development studio in Ottawa. Fast websites, custom applications and automation for local businesses across Ottawa, Kanata, Barrhaven, Orléans and Gatineau.',
    ogDescription:
      'Bilingual web design and development for Ottawa businesses. Fast websites, custom applications and automation, built by a senior engineer.',
  },
  ...
  hero: {
    eyebrow: 'Web design & development · Ottawa',
...
const fr = {
  meta: {
    title: 'Conception de sites web à Ottawa | Zyvanta',
    description:
      'Agence web bilingue à Ottawa. Conception de sites web rapides, applications sur mesure et automatisation pour les entreprises d’Ottawa, Kanata, Barrhaven, Orléans et Gatineau.',
    ogDescription:
      'Conception de sites web bilingue pour les entreprises d’Ottawa. Sites rapides, applications sur mesure et automatisation, par un ingénieur senior.',
  },
  ...
  hero: {
    eyebrow: 'Conception et développement web · Ottawa',
